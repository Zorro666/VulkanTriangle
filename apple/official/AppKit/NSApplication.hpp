...
{
  return NS::Object::sendMessage< NS::Event * >( this, _APPKIT_PRIVATE_SEL( nextEventMatchingMask_untilDate_inMode_dequeue),
                                           mask, expiration, mode, deqFlag ? YES : NO);
}

_NS_INLINE void NS::Application::sendEvent( NS::Event* event )
{
  NS::Object::sendMessage< void >( this, _APPKIT_PRIVATE_SEL( sendEvent ), event );
}
