...
_APPKIT_PRIVATE_DEF_SEL( finishedLaunching,
            "isFinishedLaunching" );
...
_APPKIT_PRIVATE_DEF_SEL( sendEvent,
            "sendEvent:" );
...
_APPKIT_PRIVATE_DEF_SEL( nextEventMatchingMask_untilDate_inMode_dequeue,
...
_APPKIT_PRIVATE_DEF_SEL( contentView_,
						"contentView" );
...
_APPKIT_PRIVATE_DEF_SEL( visible_,
            "isVisible" );
